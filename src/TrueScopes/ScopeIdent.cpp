...
namespace TrueScopes::ScopeIdent
{
	namespace
	{
		...
		constexpr TableEntry kTable[] = {
			// key, aperture, measured shape, ocular face in that shape's own coords
			{ "MachineGunScope", 0.759f, "MachineGunScope:6", { -0.011f, -5.457f, 3.373f } , 4.944f },
			{ "GaussRifleScope", 1.028f, "GaussRifleScope:0", { 0.022f, -3.260f, 1.500f } , 2.424f },
			{ "MissileLauncherScope", 1.105f, "MissileLauncherScope:0", { -10.101f, -2.869f, 3.277f } , 5.961f },
			{ "LaserScope", 1.175f, "LaserScope:0", { -0.007f, -8.539f, 3.389f } , 6.432f },
			{ "HuntingScope", 1.267f, "HuntingScope:2", { 0.000f, -6.422f, 1.814f } , 11.043f },
			{ "44MagScope", 1.290f, "44MagScope:0", { -0.002f, -8.539f, 2.118f } , 8.657f },
			{ "HandMadeScope", 1.477f, "HandMadeScope:0", { 0.007f, -6.715f, 2.604f } , 8.078f },
			// MachineGunScopeF -- the mesh really does name its root Box121
			{ "Box121", 1.592f, "Box121:6", { -0.016f, -5.527f, 3.319f } , 5.014f },
			{ "PipeReflex", 1.597f, "PipeReflex:0", { 0.175f, -3.750f, 2.415f } , 2.883f },
			{ "LaserScope002", 1.640f, "LaserScope002:0", { -0.498f, -2.957f, 2.852f } , 4.550f },
			{ "RailwayRifleScope", 1.864f, "RailwayRifleScope:0", { 0.034f, -0.773f, 0.935f } , 4.857f },
			{ "FatmanScope", 2.159f, "FatmanScope:0", { -2.223f, -6.680f, -7.689f } , 4.826f },
			{ "44MagReconScope", 2.184f, "44MagReconScope:1", { -0.604f, -4.797f, 3.034f } , 4.050f },
			{ "Pistol_scope_Railway", 2.184f, "Pistol_scope_Railway:0", { -0.636f, -1.538f, 1.118f } , 4.051f },
			{ "GaussRifleReconScope", 2.184f, "GaussRifleReconScope:1", { -0.531f, -4.012f, 2.788f } , 4.039f },
			{ "Pistol_scope", 2.184f, "Pistol_scope:0", { -0.604f, -5.594f, 2.285f } , 4.052f },
			{ "PlasmaScope002", 2.185f, "PlasmaScope002:1", { -0.627f, -0.332f, 3.542f } , 4.051f },
			{ "InstituteReconScope", 2.288f, "InstituteReconScope:0", { -0.011f, -6.969f, 5.355f } , 8.681f },
			{ "ReconScopeRifle", 2.288f, "ReconScopeRifle:0", { -0.005f, -1.994f, 3.612f } , 8.680f },
			{ "AssaultRifleScope", 2.290f, "AssaultRifleScope:0", { -0.005f, -10.516f, 3.052f } , 8.680f },
			{ "Scope", 3.058f, "Scope:0", { 0.769f, -13.750f, 4.406f } , 4.782f },  // Laser_Gun_Set_10
			{ "MGThermalScope", 3.539f, "MGThermalScope:0", { 2.166f, -3.225f, 1.559f } , 3.307f },
			{ "Scope01", 4.366f, "Scope01:0", { 0.000f, -5.059f, 2.985f } , 6.633f },  // alien blaster
			{ "PlasmaScope", 4.564f, "PlasmaScope:1", { 0.000f, -2.012f, 2.309f } , 6.117f },
		};
