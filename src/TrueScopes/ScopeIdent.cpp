...
namespace TrueScopes::ScopeIdent
{
	namespace
	{
		...
		constexpr TableEntry kTable[] = {
			// Generated by tools/scope-census.py --cpp (investigation repo),
			// 2026-08-24 revision: rear-RIM rule for tube optics (calibrated on
			// the two hand-tuned VR ground truths), paired-quad screen rule,
			// rectangular-screen aspect, and the 8 rows VR-verified in gate
			// pass 2 pinned at their verified values. DLC rows measured from
			// the DLCCoast/DLCNukaWorld BA2s.
