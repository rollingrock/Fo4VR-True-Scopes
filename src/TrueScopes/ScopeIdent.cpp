...
namespace TrueScopes::ScopeIdent
{
	namespace
	{
		...
		constexpr TableEntry kTable[] = {
			// key, aperture, measured shape, ocular face (file coords), |face - bound centre|
		{ "MGThermalScope", 0.685f, "Screen023:0", { 0.000f, 0.004f, 0.000f }, 0.000f },  // MGScopeThermal_1.nif via screen
		{ "MachineGunScope", 0.690f, "MachineGunScope:7", { -0.005f, -2.875f, 3.356f }, 0.001f },  // MGScope_1.nif via screen
		{ "Box121", 0.690f, "Box121:7", { -0.005f, -2.875f, 3.356f }, 0.001f },  // MachineGunScopeF.nif via screen
		{ "GaussRifleScope", 1.028f, "GaussRifleScope:0", { 0.022f, -3.260f, 1.500f }, 2.424f },  // GaussRifleScope_1.nif via body
		{ "MissileLauncherScope", 1.105f, "MissileLauncherScope:0", { -10.101f, -2.869f, 3.277f }, 5.961f },  // MissileLauncherScope_1.nif via body
		{ "LaserScope", 1.175f, "LaserScope:1", { -0.010f, -8.539f, 3.733f }, 6.430f },  // LaserMusketLaserScope.nif via body
		{ "LaserScope", 1.175f, "LaserScope:0", { -0.007f, -8.539f, 3.389f }, 6.432f },  // LaserScope_1.nif via body
		{ "44MagReconScope", 1.206f, "Screen023:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Pistol_scope_44Mag.nif via screen
		{ "GaussRifleReconScope", 1.206f, "Screen024:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Pistol_Scope_Gauss.nif via screen
		{ "LaserScope", 1.206f, "Screen021:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Pistol_scope_laser.nif via screen
		{ "PlasmaScope002", 1.206f, "Screen019:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Pistol_scope_Plasma.nif via screen
		{ "Pistol_scope_Railway", 1.206f, "Screen018:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Pistol_scope_Railway.nif via screen
		{ "Pistol_scope", 1.206f, "Screen020:1", { 0.000f, -0.004f, -0.001f }, 0.000f },  // Recon_Pistol_scope.nif via screen
		{ "HuntingScope", 1.267f, "HuntingScope:2", { 0.000f, -6.422f, 1.814f }, 11.043f },  // HuntingRifleScope_1.nif via glass
		{ "44MagScope", 1.290f, "44MagScope:0", { -0.002f, -8.539f, 2.118f }, 8.657f },  // 44Scope_1.nif via body
		{ "HandMadeScope", 1.477f, "HandMadeScope:0", { 0.007f, -6.715f, 2.604f }, 8.078f },  // HandMadeScopeZoom_1.nif via body
		{ "ReconScopeRifle", 1.484f, "Screen016:1", { 0.006f, -6.816f, 5.340f }, 0.002f },  // ReconScopeRifle.nif via screen
		{ "AssaultRifleScope", 1.484f, "Screen017:1", { 0.006f, -6.816f, 5.340f }, 0.002f },  // Rifle_Scope_Assault.nif via screen
		{ "InstituteReconScope", 1.484f, "Screen018:1", { 0.006f, -6.816f, 5.340f }, 0.002f },  // Rifle_Scope_Institute.nif via screen
		{ "PipeReflex", 1.597f, "PipeReflex:0", { 0.175f, -3.750f, 2.415f }, 2.883f },  // HandmadeScope_1.nif via body
		{ "LaserScope002", 1.640f, "LaserScope002:0", { -0.498f, -2.957f, 2.852f }, 4.550f },  // LaserScopeNoBracket.nif via body
		{ "RailwayRifleScope", 1.864f, "RailwayRifleScope:0", { 0.034f, -0.773f, 0.935f }, 4.857f },  // RailwayRifleScope_1.nif via body
		{ "FatmanScope", 2.159f, "FatmanScope:0", { -2.223f, -6.680f, -7.689f }, 4.826f },  // FatmanScope_1.nif via body
		{ "Scope", 3.058f, "Scope:0", { 0.769f, -13.750f, 4.406f }, 4.782f },  // Scope_1.nif via body
		{ "Scope01", 4.366f, "Scope01:0", { 0.000f, -5.059f, 2.985f }, 6.633f },  // Scope01_1.nif via body
		{ "PlasmaScope", 4.564f, "PlasmaScope:1", { 0.000f, -2.012f, 2.309f }, 6.117f },  // Scope_1.nif via body
		};
		...
		void Resolve(Info& a_out)
		{
			...
			// Among rows sharing a key, PREFER THE ONE WHOSE MEASURED SHAPE IS
			...
			for (std::uint32_t i = 0; i < a_out.scopeNameCount && !a_out.fromTable; ++i) {
				...
				if (!a_out.fromTable && keyOnly) {
					CopyName(a_out.matched, keyOnly->node);
					CopyName(a_out.faceShape, keyOnly->shape);  // for the warning
					a_out.aperture = keyOnly->aperture;
					a_out.fromTable = true;
				}
			}
