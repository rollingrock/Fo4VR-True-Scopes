	...
	namespace
	{
		...
		std::vector<Entry> SettingTable()
		{
			...
			return {
				...
				{ "magnificationScale", Kind::Float, &magnificationScale },
				{ "magnificationMax", Kind::Float, &magnificationMax },
				{ "scopeFrustumExact", Kind::Bool, &scopeFrustumExact },
				...
				{ "poseLateralDistanceAdapt", Kind::Float, &poseLateralDistanceAdapt },
				{ "poseLateralRefDist", Kind::Float, &poseLateralRefDist },
